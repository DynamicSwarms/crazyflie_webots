...
class Crazyflie(Node):
    ...
    def __init__(self):
        ...
        self.cmd_position_pub = self.create_publisher(Position, prefix + '/cmd_position', 10)
        ...
        self.create_subscription(GenericLogData, prefix  + "/zrange", self._zrange_callback, 1)
    ...
    def _zrange_callback(self, msg):
        self.zrange = msg.values[0]
